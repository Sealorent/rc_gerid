        ...
        <div class="col-lg-4">
            <div class="page-header-breadcrumb">
                <ul class=" breadcrumb breadcrumb-title breadcrumb-padding">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('bank-data.index') }}">{{ ucwords( Request::segment(1) )}}</a> </li>
                    <li class="breadcrumb-item"><a href="{{ route('bank-data.index') }}">{{ ucwords( Request::segment(2) )}}</a> </li>
                </ul>
            </div>
        </div>
    </div>
                        ...
                        <form action="{{ route('kasus.store') }}" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="no_kasus" id="no_kasus" value="{{ old('no_kasus') }}"
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="umur" id="umur" value="{{ old('umur') }}"
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="kelompok_umur" id="kelompok_umur" class="form-control @error('kelompok_umur') is-invalid @enderror ">
                                            ...
                                            <option value="{{ $item->id }}" {{ old('id')==$item->id ? 'selected' : ' ' }}>{{ $item->kelompok_umur }}</option>
                                            @endforeach
                                    </select>
                                    @error('kelompok_umur')
                                    <span class="invalid-feedback message">
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="jenis_kelamin" id="jenis_kelamin" class="form-control @error('jenis_kelamin') is-invalid @enderror ">
                                            ...
                                            <option value="1" {{ old('id')==1 ? 'selected' : ' ' }}>Male</option>
                                            <option value="2" {{ old('id')==2 ? 'selected' : ' ' }}>Female</option>
                                    </select>
                                    @error('jenis_kelamin')
                                    <span class="invalid-feedback message">
                                        {{ $message }}
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="transmisi" id="transmisi" class="form-control @error('transmisi') is-invalid @enderror ">
                                            ...
                                            <option value="{{ $item->id }}" {{ old('id')==$item->id ? 'selected' : ' ' }}>{{ $item->transmisi }}</option>
                                            @endforeach
                                    </select>
                                    @error('transmisi')
                                    <span class="invalid-feedback message">
                            ...
                            <div class="d-flex justify-content-end mt-2">
                                <a href="{{  route('kasus.index') }} " class="btn btn-danger me-1">Batal</a>

                    ...
                    <div class="card-block">
                        <form action="{{ route('pengarang.update', $pengarang->id) }}" method="post">
                            ...
                            <div class="row">
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="pengarang" id="pengarang"
                                        value="{{ old('pengarang', $pengarang->nama_pengarang) }}"
                                ...
                                <div class="col-6 mb-3">
                                    ...
                                    <input type="text" name="anggota" id="anggota"
                                        value="{{ old('anggota', $pengarang->anggota) }}"
                                ...
                                <div class="col-6 mb-3">
                                    <label for="institusi" class="form-label">Institusi First Author<small
                                            class="text-danger"> *</small>
                                    </label>
                                    <input type="text" name="institusi" id="institusi"
                                        value="{{ old('institusi', $pengarang->institusi) }}"
                            ...
                            <div class="d-flex justify-content-end">
                                <a href="{{ route('pengarang.index') }}" class="btn btn-danger me-1"> Batal </a>

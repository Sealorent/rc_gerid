            ...
            <div class="page-body">
                ...
                <div class="card">
                    ...
                    <div class="card-block">
                        <form action="{{ route('bank-data.update', $data->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="nama_pengarang" id="nama_pengarang"
                                        ...
                                        <option value="{{ $item->id }}" {{ old('nama_pengarang') or $data->id_pengarang
                                            ==$item->i ? 'selected' : ' ' }}>{{ $item->nama_pengarang }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="judul_artikel" id="judul_artikel"
                                        value="{{ old('judul_artikel', $data->judul_artikel) }}"
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="tempat" id="tempat"
                                        ...
                                        placeholder="Masukkan Tempat Pengambilan Sampel"
                                ...
                                <div class="col-4">
                                    ...
                                    <div class="input-group ">
                                        <input type="text" class="form-control @error('tanggal') is-invalid @enderror"
                                            ...
                                            value="{{ old('tanggal',date('Y-m',strtotime($data->tanggal_pengambilan))) }}">
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="id_provinsi" id="id_provinsi"
                                        ...
                                        <option value="{{ $item->id }} " {{ old('id_provinsi', $data->id_provinsi) ==
                                            $item->id ? 'selected' : ' ' }}>
                                ...
                                <div class="col-4 mb-3">
                                    <input type="text" value="{{ $data->id_kota }}" id="kota" hidden>
                            ...
                            <div class="row">
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="kode_sampel" id="kode_sampel"
                                        value="{{ old('kode_sampel', $data->kode_sampel) }}"
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="id_virus" id="id_virus"
                                        ...
                                        <option value="{{ $item->id }}" {{ old('id_virus', $data->id_virus) == $item->id
                                            ? "selected" : " "}}>{{ $item->nama_virus }}</option>
                                        @endforeach
                                    </select>
                                    @error('id_virus')
                                    <span class="invalid-feedback message">
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <select name="genotipe" id="genotipe"
                                        ...
                                        <option value="{{ $item->id }}" {{ old('genotipe', $data->kode_genotipe) ==
                                            $item->id
                                            ? "selected" : " "}}>{{ $item->kode_genotipe }}</option>
                                        @endforeach
                                    </select>
                                    @error('genotipe')
                                    <span class="invalid-feedback message">
                                ...
                                <div class="col-4 mb-3">
                                    ...
                                    <input type="text" name="nama_gen" id="nama_gen"
                                        ...
                                        placeholder="Masukkan Kode Sampel"
                                        value="{{ old('nama_gen', $data->nama_gen) }}">
                                    @error('nama_gen')
                                    <span class="invalid-feedback message">
                                        {{ $message }}
                                    </span>
                                ...
                                <div class="col-8 mb-3">
                                    ...
                                    <textarea rows="10" type="text" name="data_sekuen" id="data_sekuen"
                                        ...
                                        placeholder="Masukkan Data Sekuen">{{ $data->data_sekuen }}</textarea>
                                    @error('data_sekuen')
                                    <span class="invalid-feedback message">
                                        {{ $message }}
                                    </span>
    ...
    $(document).ready(function () {
        ...
        $.ajax({
                ...
                success: function(res){
                    ...
                    $("#id_kabupaten").val($('#kota').val()).change();
                }
        });

                ...
                <div class="card">
                    <div class="card-header bg-light">
                        <div class="d-flex justify-content-between align-middle">
                            <h6 class="mt-2 fw-bold">Tambah Data Virus</h6>
        ...
        <div class="page-wrapper">
            <div class="page-body">
                ...
                <div class="card">
                    <div class="card-header bg-light">
                        <div class="d-flex justify-content-between align-middle">
                            <h6 class="mt-2 fw-bold">Data Virus</h6>
                        </div>
                    </div>
                        ...
                        <div class="dt-responsive table-responsive">
                            <table class="table table-striped table-bordered nowrap" id="table-virus">
                                <thead>
                                    <tr>
                                        <th style="width: 4%">#</th>
                                        <th style="width: 70%">Nama Virus</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="{{ route('virus.show', $item->id) }}">{{ $item->nama_virus }}</a>
                                        </td>
                                        <th>

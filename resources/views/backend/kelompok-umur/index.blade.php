                ...
                <div class="card">
                    <div class="card-header bg-light">
                        <div class="d-flex justify-content-between align-middle">
                            <h6 class="mt-2 fw-bold">Tambah Data Kelompok Umur</h6>
                    ...
                    <div class="card-block collapse {{ session()->has('errors') == 1 ? 'show' : '' }}"
                        id="collapseExample">
                        <form action="{{ route('kelompok-umur.store') }}" method="post">
                            @csrf
                            <div class="row">
                                <div class="col-4 mb-3">
                                    <input type="text" name="kelompok_umur" id="disabledTextInput" class="form-control @error('kelompok_umur') is-invalid @enderror" placeholder="Masukkan Kelompok Umur">
                                    @error('kelompok_umur')
        ...
        <div class="page-wrapper">
            <div class="page-body">
                ...
                <div class="card">
                    <div class="card-header bg-light">
                        <div class="d-flex justify-content-between align-middle">
                            <h6 class="mt-2 fw-bold">Data Kelompok Umur</h6>
                        </div>
                    </div>
                        ...
                        <div class="dt-responsive table-responsive">
                            <table class="table table-striped table-bordered nowrap" id="table-virus">
                                <thead>
                                    <tr>
                                        <th style="width: 4%">#</th>
                                        <th style="width: 70%">Kelompok Umur</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td> <a href="{{ route('kelompok-umur.show', $item->id) }}">{{ $item->kelompok_umur }}</a>
                                        </td>
                                        <th>
                                            <div class="d-flex justify-content-start">
                                                ...
                                                <form action="{{  route('kelompok-umur.destroy',$item->id) }}" method="post">
                                                    @csrf
                                                    @method('delete')
                                    ...
                                    @include('backend.kelompok-umur.editModal')
                                    @empty
                                    <tr>
